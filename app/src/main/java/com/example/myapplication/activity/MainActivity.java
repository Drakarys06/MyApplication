    ...
    public void showListUE(ButBean butBean) {
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                ArrayAdapter<UEBean> adapter = new ArrayAdapter<UEBean>(this,
                        simple_spinner_item,
                        listUEBean);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                binding.spinnerUE.setAdapter(adapter);
                binding.spinnerUE.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    @Override
                    //fonction qui existe
                    //selectionne l'item du spinner
                    //hanbler : event onChange
